 ...
 */
define(['jquery', 'ractive', 'ui', 'is'], function ($, Ractive, UI, is) {
        ...
        var loadCurData = function (prevChoice, data){
            ...
            if (tabData && tabData.data && tabData.data.length>0)  {
                ...
                for (var i = 0; i < tabData.data.length; i++){
                    ...
                    $content.append('<div class="item"><a href="javascript:void(0)" data-index="'+i+'" title="'+item[tabData.showField]+'">'+item[tabData.showField]+'</a></div>');
                }

                /*$(".choice-ganged-tooltip").tooltip({
                    placement:'bottom',
                    customClass:'base-tooltip'
                });*/
